...
de un Amplificador de tension con muestra de tension en serie, la muestra de tension se da a partir de $R_f$ y se
conecta al emisor de $Q_1$ que forma parte de la malla de entrada del respectivo transistor.

\begin{figure}[!ht]
    \centering
    \resizebox{0.95\textwidth}{!}{\input{figures/fig_esquematico_ampli.tex}}

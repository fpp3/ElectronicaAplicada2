...
\section{Medición de Desensibilidad}
  Para esta prueba se provocó una variación máxima de $A_v$ del $45 \percent$, modificando una resistencia de emisor, en
  este caso, $R_{e3}$. Las mediciones se realizaron a una frecuencia de $f_s = 1.5 \text{ kHz}$, utilizando:
\begin{itemize}

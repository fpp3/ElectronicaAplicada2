...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_adaptador_impedancia.tex}
...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_level_shifter.tex}
...
tiempo gracias al offset agregado anteriormente, podemos generar la señal triangular obteniendo una tensión que
...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_integrator_pre.tex}
...
\begin{figure}[!ht]
  \centering
  \input{figures/plot_integrated_pre.tex}
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[c]{0.6\textwidth}
    \input{figures/crkt_diferenciador.tex}
    \caption{circuito.}
...
Con la señal triangular siendo generada a partir de la integral de la señal de entrada cuadrada, ahora debemos
volver a la señal de onda cuadrada a partir de la triangular. Para "deshacer" los efectos matemáticos de la señal
triangular, podemos colocar un amplificador operacional en configuración derivadora, para volver a la señal
...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_derivator.tex}
...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_2nd_derivator.tex}
  \caption{circuito amplificador operacional en configuración derivador.}
...
\begin{figure}[!ht]
  \centering
  \input{figures/crkt_rectificador.tex}
...
\begin{figure}[!ht]
  \centering
  \input{figures/plot_rectified_pre.tex}
...
\begin{figure}[!ht]
  \centering
  \begin{subfigure}[c]{0.6\textwidth}
    \input{figures/crkt_amplificador_no_inversor.tex}
    \caption{circuito.}

...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[c]{0.3\textwidth}
    ...
    \caption{ecuación.}
  \end{subfigure}
  \caption{amplificador operacional en connfiguración diferenciador.}
\end{figure}
...
($\delta_{(t)}$). Como no es perfecta la recomposicion de la señal cuadrada, la señal resultante será parecida a un pico
...
El esquematico completo está anexado al final del informe.
